...
while ($data = mysqli_fetch_assoc($sql)) {
    ...
    $response['table'] .= '<td><a href="laporan.php?view=' . $data['id_laporan'] . '" target="_blank" class="btn btn-primary">Lihat</a><a href="edit.php?edit=' . $data['id_laporan'] . '" class="btn btn-danger">Edit</a></td>';
    $response['table'] .= "</tr>";
    $row_number++;
}
